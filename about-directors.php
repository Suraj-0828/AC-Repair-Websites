...
<body>
    ...
    background-size: cover;">
        ...
        <!-- Founder Ceo Start -->
        <div class="background-color pt-70 pb-70">
            <div class="container">
                <div class="section-styling-area mb-50">
                    <h2 class="text-center mb-40">Driving Excellence and Innovation</h2>
                </div>
                <div class="row">
                    <!-- Team Member 2 -->
                    <div class="col-md-12">
                        <div class="team-member-card">
                            <div class="row">
                                <div class="col-lg-4">
                                    <!-- Image Section -->
                                    <div class="">
                                        <img src="assets/images/home/abc-2/client-2.png" alt="John Doe" class="img-fluid">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <!-- Text Section -->
                                    <div class="team-member-text">
                                        ...
                                        <p>As the Founder and CEO of [Your Company Name], [Director Name] has been instrumental in shaping the company’s mission and growth. With over [X years] of experience in the HVAC and water systems industry, [Director Name] brings unmatched expertise and a deep understanding of customer needs.
                                        </p>
                                        ...
                                        <div class="about_two_list_wrapper pt-4 pb-3">
                                            <ul class="p-0">
                                                ...
                                                <li class="d-flex">
                                                    ...
                                                    <div class="fs-18">
                                                        Spearheading the development of eco-friendly and energy-efficient solutions
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex">
                                                    ...
                                                    <div class="fs-18">
                                                        Building a culture of innovation and customer-first practices.
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex">
                                                    ...
                                                    <div class="fs-18">
                                                        Expanding operations across [regions or areas].
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
